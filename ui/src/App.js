...
function App() {
  return (
    <div className="bg-[#01125E] w-[100vw] h-[100vh] flex justify-center items-center box-border md:relative">
      <div className="absolute hidden md:flex md:items-right md:bg-white md:w-[95vw] md:h-[75vh] md:top-16 z-10">
      ...
      <Login />
      <div className="hidden md:flex z-20 absolute md:bottom-14 md:right-28 lg:right-36">
        <Footer />
      </div>
    </div>
  );
